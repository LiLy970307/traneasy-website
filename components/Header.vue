      ...
      <div class="relative z-10 flex items-center justify-between h-[68px]">
        ...
        >
          ...
          <NuxtLink
            v-if="!isLoggedIn"
            @click="goLogin"
            class="ml-1 text-slate-600 hover:text-blue-600 border border-slate-200 hover:border-blue-300 text-sm font-medium px-4 py-2 rounded-full transition-colors whitespace-nowrap flex-shrink-0 cursor-pointer"
          >
            {{ $t("nav.login") }}
          </NuxtLink>
          <span
